...
class Question extends Equatable {
  ...
  ///The parameter that indicates whether the question is a scale (1 to 5).
  final bool scaleChoice;
  ...
  List<Object?> get props =>
      [question, singleChoice, scaleChoice, answerChoices, isMandatory];
}
